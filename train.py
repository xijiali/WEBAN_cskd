...
parser.add_argument('--name', default='2', type=str, help='name of run')
parser.add_argument('--batch-size', default=128, type=int, help='batch size')
parser.add_argument('--epoch', default=40, type=int, help='total epochs to run')#40
...
parser.add_argument('--dataroot', default='/gruntdata4/xiaoxi.xjl/classification_datasets/', type=str, help='data directory')
